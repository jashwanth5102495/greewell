...
export const PRODUCTS = [
  ...
  },
  {
    ...
    category: 'Humic Acid and Fulvic Acid and their Derivatives',
    crops: ['Green gram'],
    dosage: ['Two soil applications at 5.0 l/ha'],
    gazette: '16th February, 2026 S.O. 876(E)',
    composition: [
  ...
  },
  {
    ...
    category: 'Mixed Formulations',
    crops: ['Cotton and Potato'],
    dosage: ['Two foliar applications at 1.25 kg/ha'],
    gazette: '26th May, 2025 S.O. 2346E)',
    composition: [
  ...
  {
    brand: 'DR.HUMUS',
    specification: 'Mixture of Humic acid and Seaweed extract (Liquid)',
    category: 'Mixed Formulations',
    crops: ['Tomato'],
    dosage: ['Three foliar applications at 1.25 l/ha'],
    gazette: '26th May, 2025 S.O. 2346E).',
...
export const SLUG_TO_BRAND = {
  ...
  'BLACK-DRAGON': 'BLACK DRAGON',
  'BLACK%20DRAGON': 'BLACK DRAGON',
  'MICRO CELL': 'MICRO CELL',
  'MICRO-CELL': 'MICRO CELL',
  'MICRO%20CELL': 'MICRO CELL',
  'GROW': 'GROW',
  'HUMIC KING': 'HUMIC KING',
  'HUMIC-KING': 'HUMIC KING',
  'HUMI DRIP': 'HUMI DRIP',
  'HUMI-DRIP': 'HUMI DRIP',
  'GREEN SHAKTI': 'GREEN SHAKTI',
  'GREEN-SHAKTI': 'GREEN SHAKTI',
  'FIGHTER 98': 'FIGHTER 98',
  'FIGHTER-98': 'FIGHTER 98',
  'FARM VITAL': 'FARM VITAL',
  'FARM-VITAL': 'FARM VITAL',
